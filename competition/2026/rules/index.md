...
This page summarizes how QANTA 2026 is structured in play. **Scoring for humans** (points on the board) is in [Human Rules](/competition/2026/rules/human/). **Scoring and ranking for submitted systems** is in [Computer Rules](/competition/2026/rules/computer/).

## Tossups and bonuses in sequence

Each scoring cycle works the same way:

1. A **tossup** is read to both teams.
2. The **team that answers the tossup correctly** receives the **bonus** that follows (typically three parts on a shared theme).

That link between tossup and bonus is fixed: you earn the bonus only by winning the preceding tossup.
